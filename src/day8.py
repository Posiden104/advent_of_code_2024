...
def find_antinodes_by_freq(freq, locs):
    anodes = set()
    # print(freq)
    # print(locs)
    for i, a in enumerate(locs):
        ...
        for j, b in enumerate(locs, i + 1):
            ...
            if v1[0] >= 0 and v1[0] < len(input) and v1[1] >= 0 and v1[1] < len(input[0]) and (v1 != (0,0)):
                # print(f'adding {v1}')
                anodes.add(v1)
            if v2[0] >= 0 and v2[0] < len(input) and v2[1] >= 0 and v2[1] < len(input[0]) and (v2 != (0,0)):
                # print(f'adding {v2}')
                anodes.add(v2)
            # print(anodes)
